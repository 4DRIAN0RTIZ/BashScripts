...
# Verifica si las dependencias están instaladas y las instala si no lo están
...
# Se crea el directorio donde se guardará la copia de seguridad solo si no existe
...
# Se define ruta de origen y destino
